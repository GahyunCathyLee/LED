...
def main():
    ...
    parser.add_argument('--ckpt',   type=str, required=True, help='Path to initializer checkpoint (best.pt)')
    ...
    ade        = ade_sum / samples
    fde        = fde_sum / samples
    rmse       = math.sqrt(sq_sum_all / (samples * T_F))   # 전체 프레임 평균 RMSE
